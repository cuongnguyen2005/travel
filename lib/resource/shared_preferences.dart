...
class SharedPreferencesLocal {
  ...
  static Future<List<UserAccount>> getUserAccount() async {
  ...
  static Future<List<YourPlacesFavorite>> getPlacesUid(String uid) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  static Future<List<YourBooked>> getPlacesBookUid(String uid) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  static Future<void> saveUserAccount(List<UserAccount> userAccount) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  static Future<void> saveYourPlaceFavorite(
  ...
  static Future<void> saveYourPlaceBooked(
      List<YourBooked> places, String uid) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    //chuyển list thành 1 list Map
    final List<Map<String, dynamic>> listPlaces =
        places.map((e) => e.toMap()).toList();
